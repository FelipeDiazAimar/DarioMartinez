...
export default function AdminLoginPage() {
  ...
  return (
    <>
      ...
      <AlertDialog open={showRememberDialog} onOpenChange={setShowRememberDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Mantener sesión iniciada</AlertDialogTitle>
            <AlertDialogDescription>
              ¿Desea que recordemos su sesión en este dispositivo? Si elige &quot;No&quot;, su sesión se cerrará cuando cierre el navegador.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <Button variant="outline" onClick={() => handleRememberChoice(false)}>
                No, solo esta sesión
            </Button>
            <Button onClick={() => handleRememberChoice(true)}>
              Sí, recordar
            </Button>
          </AlertDialogFooter>
        </AlertDialogContent>
