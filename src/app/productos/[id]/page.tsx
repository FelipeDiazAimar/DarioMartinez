...
export default async function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  try {
    ...
    const whatsappMessage = `Hola, quisiera consultar o encargar el producto: ${item.title}.`;
    const whatsappHref = `https://wa.me/5493564504977?text=${encodeURIComponent(whatsappMessage)}`;
        ...
        <main className="mx-auto w-full max-w-6xl space-y-6 p-6">
          ...
          {relatedItems.length === 0 ? (
            ...
            >
              ...
              <Link href="/productos" className="mt-3 inline-flex rounded-full border bg-white px-4 py-2 text-sm font-medium hover:bg-muted">
